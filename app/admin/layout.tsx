...
export default function AdminLayout({
    ...
    return (
        <div className="min-h-screen bg-zinc-900" x-data="{ sidebarOpen: true, dropdownOpen: false }">
            {/* Sidebar */}
            <aside 
                className="fixed inset-y-0 left-0 z-50 w-64 bg-zinc-950 border-r border-zinc-800 transform transition-transform duration-300 lg:translate-x-0"
